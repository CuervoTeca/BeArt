...
import { close, closeCircle, trash } from 'ionicons/icons';
import axios from 'axios';

const ModalDeleteUsers: React.FC = () => {
  //Abrir el modal
...
const [ShowErrorToast, setShowErrorToast] = useState(false);
  ...
  return (
    <>
    <IonButton className="LoginPass"   color="danger" onClick={openModal}>
        <IonIcon size='large' icon={trash}></IonIcon>Eliminar
    </IonButton>
